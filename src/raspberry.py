...
GPIO.output(RELAY_PIN, GPIO.HIGH)  # Initially off; HIGH = OFF (inverted)
...
# Function to detect objects and draw rectangles, confidence, green dot etc.
        ...
        for classId, confidence, box in zip(classIds.flatten(), confs.flatten(), bbox):
            ...
            if className in objects:
                ...
                if draw:
                    ...
                    cv2.putText(img, f"{className.upper()} {round(confidence*100,2)}%", (box[0]+10, box[1]+30),
                                cv2.FONT_HERSHEY_SIMPLEX, 0.6, (0,255,0), 2)
                    cv2.circle(img, (center_x, center_y), 5, (0,255,0), -1)
    return img, objectInfo

# Tracking and scan state
...
lost_since = None  # when object was lost
...
if __name__ == "__main__":
    ...
    try:
        while True:
            ...
            # Detect objects (change target here)
